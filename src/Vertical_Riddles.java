...
public class Vertical_Riddles implements ActionListener {
	...
	public void makeQues() {
		question[0] = "What has to be broken before you an use it" ;
		question[1] = "I'm tall when I'm young and short when I'm old, What am I" ;
		question[2] = "What month of the year has 28 days" ;
		question[3] = "What is full of holes but still holds water" ;
		question[4] = "What is always in front of you but can’t be seen" ;
		question[5] = "What can you break, even if you never pick it up or touch it " ;
		question[6] = "What goes up but never comes down" ;
		question[7] = "What gets wet while drying" ;
		question[8] = "What can you keep after giving to someone" ;
		question[9] = "I shave every day, but my beard stays the same" ;
		answer[0] = "egg" ;
		answer[1] = "candle" ;
		answer[2] = "All" ;
		answer[3] = "Sponge" ;
