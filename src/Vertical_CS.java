...
public class Vertical_CS implements ActionListener {
	...
	public void makeQues() {
		question[0] = "A light sensitive class that converts drwaing,printed text or other images into digital form? " ;
		question[1] = "The basic architecture of computer was developed by- " ;
		question[2] = "In how many generation a computer can be classified- " ;
		question[3] = "Fifth generation computer are based on-" ;
		question[4] = "GUI stands for-" ;
		question[5] = "Time during which a job is processed by  computer is-" ;
		question[6] = "An error is also known as- " ;
		question[7] = "Who invented super computer? " ;
		question[8] = "The 'IC' chip used in computer is made of?" ;
		question[9] = "First Intel processor introduced is-" ;
		answer[0] = "Scanner" ;
		answer[1] = "John Von Neumann" ;
		answer[2] = "sleeping" ;
		answer[3] = "5" ;
		answer[4] = "Graphical User Interface" ;
		answer[5] = "Execution time" ;
		answer[6] = "Bug" ;
		answer[7] = "Seymour Cray" ;
		answer[8] = "Silicon" ;
		answer[9] = "4004" ;
	}
