...
public class New_ques implements ActionListener{
	...
	public New_ques(String filename) {
		initialize();
	...
	private void initialize() {
		...
		JLabel think1 = new JLabel("New label");
		think1.setIcon(new ImageIcon("think.gif"));
		think1.setBounds(35, 21, 208, 206);
		panel.add(think1);
		
		JLabel think2 = new JLabel("New label");
