					...
					.addGroup(layout.createSequentialGroup()
							...
							.addGroup(layout.createParallelGroup(Alignment.LEADING)
									.addGroup(layout.createSequentialGroup()
											...
											.addGroup(layout.createParallelGroup(Alignment.LEADING)
													.addComponent(user_field, GroupLayout.DEFAULT_SIZE, 150,
															Short.MAX_VALUE)
													.addComponent(name_field, GroupLayout.DEFAULT_SIZE, 150,
															Short.MAX_VALUE)
													.addComponent(pass_field, GroupLayout.DEFAULT_SIZE, 150,
															Short.MAX_VALUE)
													.addComponent(con_field, GroupLayout.DEFAULT_SIZE, 150,
															Short.MAX_VALUE)))
									.addComponent(usename_warn, GroupLayout.PREFERRED_SIZE, 200,
											GroupLayout.PREFERRED_SIZE)
									.addComponent(pass_warn, GroupLayout.PREFERRED_SIZE, 200,
											GroupLayout.PREFERRED_SIZE)
	...
	layout.setVerticalGroup(
			layout.createParallelGroup(Alignment.LEADING)
					...
					.addGroup(layout.createSequentialGroup()
							...
							.addGap(30)
							.addComponent(book_gif, GroupLayout.PREFERRED_SIZE, 150, GroupLayout.PREFERRED_SIZE)
							.addGap(50))); // Centered GIF below button
}
