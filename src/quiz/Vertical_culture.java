...
public class Vertical_culture implements ActionListener {
	...
	public void makeQues() {
		question[0] = " 'Madhubani' , a style of folk paintings , is popular in which state? " ;
		question[1] = " In which festival, 'boat races' are special feature? " ;
		question[2] = " 'Pungi' is a dance form related to which state? " ;
		question[3] = " By whom 'Panchatantra' is originally written by? " ;
		question[4] = " Which painting involves the art of creating images on cotton cloth using the wax resist method? " ;
		question[5] = " In which state, 'Hornbill' festival held every year? " ;
		question[6] = " Which is the popular dance of Gujarat? " ;
		question[7] = " The famous Sun temple is located in which state? " ;
		question[8] = " Who is considered as the father of Jainism? " ;
		question[9] = " Kalachakra ceremony is associated with which religion? " ;
		answer[0] = "Bihar" ;
		answer[1] = "Onam" ;
		answer[2] = "Himachal Pradesh" ;
		answer[3] = "Vishnu Sharma" ;
		answer[4] = "Batik" ;
		answer[5] = "Nagaland" ;
		answer[6] = "Dandia" ;
		answer[7] = "Orissa" ;
